  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-6">Manage Officers</h1>
        ...
        <div className="bg-white p-6 rounded-lg shadow mb-8">
          ...
          <form className="grid grid-cols-1 gap-4 sm:grid-cols-2" onSubmit={handleCreate}>
            <input required placeholder="Phone Number" value={phone} onChange={e=>setPhone(e.target.value)} className="border p-2 rounded" />
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {officers.map(o => (
                <tr key={o.id}>
                  <td className="px-6 py-4 whitespace-nowrap text-sm">{o.full_name_en}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm">{o.role}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm">{o.phone_number}</td>
