          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Actor Role</th>
              ...
              {loading ? (
                ...
                logs.map((log: any) => (
                  <tr key={log.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{log.actor_role || 'SYSTEM'}</td>
